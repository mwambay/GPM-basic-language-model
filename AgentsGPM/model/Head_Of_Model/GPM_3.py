...
def GPM3_Head(setups):
    ...
    with open(rf"C:\Users\Jenovic Mwambay\Documents\Swift GPM\config\setups", "w") as f:
    ...
    try:
        def Generer_la_sortie(input_code, MAXIMUM_LENGTH_in_fuct):
                    ...
                    with open(rf"C:\Users\Jenovic Mwambay\Documents\Swift GPM\Labs\Model results.json", 'w') as file:
