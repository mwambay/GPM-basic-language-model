...
file = open(r"C:\Users\Jenovic Mwambay\Documents\Swift GPM\training data\texte_representatif.txt", encoding='utf-8')
...
for token in tableau_partiel:
    if token == "<text_stop>":
        ...
        vectorisation.append(token)
file = open(r"C:\Users\Jenovic Mwambay\Documents\Swift GPM\training data\training_data.json", 'w', encoding='utf-8')
...
def TeDS_Training():
    with open(r'C:\Users\Jenovic Mwambay\Documents\Swift GPM\training data\training_data.json', 'r', encoding="utf-8") as file:
    ...
    with open(r'C:\Users\Jenovic Mwambay\Documents\Swift GPM\model\vectors\GP-Model.json', 'w',encoding= 'utf-8') as file:
    ...
    with open(r'C:\Users\Jenovic Mwambay\Documents\Swift GPM\model\vectors\vecteur_multi_dimentionnel_back.json', 'w') as file:
        json.dump(relation_sequence_back_propagation, file)
        file.close()
    with open(r'C:\Users\Jenovic Mwambay\Documents\Swift GPM\model\vectors\vecteur_multi_dimentionnel.json', 'w') as file:
    ...
    def attention():
        ...
        with open(r"C:\Users\Jenovic Mwambay\Documents\Swift GPM\model\vectors\element_synonyme.json", 'w') as file:
